...
Jetoken is built upon the fundamentals of Buyback and increasing the investor's value which was introduced by Everise
    
Main features are
    
1) 2% tax is collected and distributed to holders for NOT SELLING
2) 9% buyback and marketing tax is collected.  3% of the 9% is use for marketing fund and other 6% is used to buyback the tokens
